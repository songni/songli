  ...
  <div class="guide_wrap">
    <div class="received_cont">
      ...
      <div class="receive_status">
        ...
        <span class="receive_num color-pink" href="" >查看礼物详情</span>
      </div>
      <div class="gift_inform">
        <span class="receive-present-text">你已成功领取{ opts.order.sender.info.nickname }的礼物。使用时请到你所选择的对应门店，点击立即使用将二维码消费凭证出示给商家，即可领取礼物。</span>
      </div>
      <div class="user_intr">
